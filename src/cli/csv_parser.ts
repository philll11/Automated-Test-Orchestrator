 ...
 */
function parseCsv(fileContent: string, requiredHeaders: string[]): Array<Record<string, string>> {
 ...
 */
export function parseComponentIdCsv(fileContent: string): string[] {
 ...
 */
export function parseMappingCsv(fileContent: string): Array<{ 
