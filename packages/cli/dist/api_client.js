 ...
 */
export async function addCredentialProfile(profileName, credentials) {
 ...
 */
export async function deleteCredentialProfile(profileName) {
 ...
 */
export async function initiateDiscovery(componentIds, credentialProfile, discoverDependencies) {
 ...
 */
export async function pollForPlanCompletion(planId) {
 ...
 */
export async function initiateExecution(planId, testsToRun, credentialProfile) {
 ...
 * @returns The completed test plan object.
 */
export async function pollForExecutionCompletion(planId) {
    let plan = await getPlanStatus(planId);
 ...
 */
export async function getExecutionResults(filters) {
