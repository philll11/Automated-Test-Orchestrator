...
async function addCredentialCommand(profile) {
    try {
...
async function listCredentialsCommand() {
    try {
...
async function deleteCredentialCommand(profile) {
    try {
